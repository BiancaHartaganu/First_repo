...
# print(lista_numere[10]) #va sari o eroare pt ca in lista exista indexul 10
...
# try:
#     print(lista_numere[10])
# except NotImplementedError as e: #codul din try nu va arunca niciodata exceptia. aceastta exxceptie nu e prinsa in try
#     print(e)
